  ...
  private async getOrCreateSettingsEntity(): Promise<AdminSettings> {
    ...
    const created = this.settingsRepo.create({
      ...
      esignProposalTermsMarkdown: [
        '## Terms & Conditions',
        '',
        'This proposal is provided by the Retailer and is subject to the final site audit, any required approvals, and supplier availability.',
        '',
        '## Electronic Signature Process',
        '',
        'Execution occurs when an image of the signatures of the parties are placed on the contract and a copy of the contract containing signatures of the Owner and Retailer is circulated by email.',
        '',
        '## Privacy',
        '',
        'We comply with applicable privacy laws when handling personal information.',
      ].join('\n'),
      esignProposalTermsVersion: 1,
      esignProposalAcceptanceMarkdown: [
        'Please sign and return to proceed. Be sure to keep a copy for your own records.',
        '',
        '- A **25% deposit** is required to initiate the process.',
        '- Final payments are to be made upon full completion of installation.',
        '',
        '**Offer validity:** this offer is valid until the expiry date shown above.',
      ].join('\n'),
      ...
      esignProposalIncludedServicesMarkdown: [
        ...
        '',
        'A **7 year workmanship warranty** applies to this installation. For other warranty information refer to the Warranty section below.',
      ].join('\n'),
      ...
      esignProposalWarrantyMarkdown: [
        '### Warranty Summary',
        '',
        '- Inverter warranty: **10 years** (see manufacturer warranty file)',
        '- Battery warranty: **10 years** (see manufacturer warranty file)',
        '- Workmanship warranty: **7 years**',
        '',
        'System component warranties are different from the system lifetime. Please see the assumptions section.',
      ].join('\n'),
      ...
      esignProposalAssumptionsMarkdown: [
        ...
        '- Estimated savings are based on usage and tariff inputs and will vary with final design and post-install usage.',
        '- Utility rates, charges, and fee structures are subject to change by your utility.',
        '',
        '### Example assumed values (replace with job-specific values when available)',
        '',
        '- Current electricity price: $0.37/kWh',
        '- Feed-in tariff: $0.08/kWh',
        '- Daily supply charge: $1.15',
      ].join('\n'),
      esignProposalAssumptionsVersion: 1,
      esignProposalQuoteAdjustmentsJson: JSON.stringify(
        [
          {
            label: 'Battery STCs (example)',
            amountExclTax: -6142,
          },
        ],
        null,
